...
CoinCharts coinchartsFromJson(String str) =>
    CoinCharts.fromJson(json.decode(str));

String coinpricesToJson(CoinCharts data) => json.encode(data.toJson());
...
class CoinCharts {
  ...
  factory CoinCharts.fromJson(Map<String, dynamic> json) => CoinCharts(
